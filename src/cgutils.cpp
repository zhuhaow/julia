...
static void emit_write_barrier(jl_codectx_t* ctx, Value *parent, Value *ptr)
{
    ...
    Value* parent_mark_bits = builder.CreateAnd(parent_type, 1 << 1);
    ...
    Value* parent_marked = builder.CreateICmpEQ(parent_mark_bits, ConstantInt::get(T_size, 1 << 1));
    ...
    Value* ptr_mark_bit = builder.CreateAnd(builder.CreateLoad(builder.CreateBitCast(emit_typeptr_addr(ptr), T_psize)), 1 << 1);
