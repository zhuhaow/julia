...
int warnonce_subtype(int ta, int invariant, uptrint_t ha, uptrint_t hb)
{
...
int warnonce_morespecific(int invariant, uptrint_t ha, uptrint_t hb)
{
...
int warnonce_typematch(int morespecific, int invariant, uptrint_t ha, uptrint_t hb)
{
    std::vector<size_t> v(4);
